...
#include <string.h>			//strcmp(), strcpy(), strlen() 등
#include <time.h>			//time()
...
#define MENU_TITLE	printf("                      				Overcalc Cobaltimer				    	    by Allen Na\n");	//문자 계열 디파인
#define PRO_TITLE	printf("                      				Overcalc PRO Cobaltimer					   by Allen Na\n");	//문자 계열 디파인
